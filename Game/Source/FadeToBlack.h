...
public:
	...
	bool SceneFadeToBlack(Module* toDisable, Module* toEnable, float frame = 60);
...
private:
	...
	//A frame count system to handle the frame time and ratio
	Uint32 frameCount = 0;
	...
	//The modules that should be switched afer the first step
